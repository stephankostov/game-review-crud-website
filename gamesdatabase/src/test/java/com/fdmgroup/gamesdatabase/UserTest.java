...
public class UserTest {
    ...
    void UserCanBeCreated(){
        ...
        userService.create(user1); //todo how do I tes create database without testing retrieve at the same time?
        assertNotNull(user1);
    }
    ...
    void UserCannotBeAdded_IfEmailNotUnique() {
        User userShouldFailToAdd = new User("steph2", "steph179@gmail.com", "pwd2");
